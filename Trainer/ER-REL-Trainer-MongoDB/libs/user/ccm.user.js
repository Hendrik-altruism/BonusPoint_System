...
( () => {
  const component = {
    name: 'user',
    ccm: '././libs/ccm/ccm-26.4.3.js',
    config: {
      "css": [ "ccm.load",
        "././libs/bootstrap-3/css/bootstrap.css",
        { "context": "head", "url": "././libs/bootstrap-3/css/font-face.css" },
        "././libs/user/resources/default.css"
      ],
//    "guest": "guest",
//    "hash": [ "ccm.load", "https://ccmjs.github.io/akless-components/modules/md5.mjs" ],
      "helper": [ "ccm.load", { "url": "./../ccm/helper-7.4.0.js", "type": "module" } ],
      "html": [ "ccm.get", "././libs/user/resources/resources.js", "html" ],
      "logged_in": true,
//    "map": user => user.user === 'john' ? 'Teacher' : 'Student',
//    "norender": true,
//    "onchange": event => console.log( 'User has logged ' + ( event ? 'in' : 'out' ) + '.' ),
      "picture": "https://akless.github.io/akless/resources/images/user.svg",
      "realm": "hbrsinfkaul",
//    "restart": true,
//    "store": "ccm-user",
